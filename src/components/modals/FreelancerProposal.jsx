...
const FreelancerProposal = ({data}) => {

  const {idUser, nameUser} = data[0]
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content position-relative">
            ...
            />
              ...
              <h4 className="mb20">Solicitud de Trabajo</h4>
              ...
              <form id="requestForm">
                ...
                <div className="mb-3">
                <label className="form-label">Descripción del Trabajo <span className='mb-1' style={{color: 'red'}}> *</span></label>
